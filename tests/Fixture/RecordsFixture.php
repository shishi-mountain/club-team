...
class RecordsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'climb_date' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => '登山日'],
        'comment' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'コメント', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'mountain_id' => 1,
                'climb_date' => '2021-10-09 21:38:03',
                'comment' => 'Lorem ipsum dolor sit amet',
                'is_deleted' => 1,
                'created' => '2021-10-09 21:38:03',
                'created_by' => 1,
                'modified' => '2021-10-09 21:38:03',
                'modified_by' => 1,
            ],
        ];
        parent::init();
